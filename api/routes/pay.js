...
function createPayRouter(purchaseService) {
  const router = Router();
  ...
  router.post('/', async (req, res) => {
    ...
    try {
      const result = await purchaseService.purchaseWithEur(Number(event_id), Number(category_id), {
        buyer_address,
...
module.exports = createPayRouter;
